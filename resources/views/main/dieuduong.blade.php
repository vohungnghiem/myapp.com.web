...
@section('title', __('main.layout-dieuduong-title1'))
@section('description', __('main.layout-dieuduong-title1'))
@section('content')
    <main>
        ...
        <section class="container">
            <nav class="breadcrumb">
                ...
                <a class="breadcrumb__step breadcrumb__step--active"
                    href="dieuduong">@lang('main.layout-dieuduong-title1')</a>
            </nav>
        </section>
                            ...
                            <div class="swiper-wrapper">
                                @foreach ($tintuc as $item)
                                    <a class="swiper-slide" href="tintuc/{{ $item->slug }}">
                                        <article>
                                            <div class="box-img"><img src="{{$item->image }}"
                                                    alt="news-1.png"></div>
